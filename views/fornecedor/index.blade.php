...
/*     if ($iduser == 3) {
    ...
    if (isset($_GET['op'])) {
        ...
        switch ($op) {
            ...
            case 3:
                ...
                // $idPed = $_GET['idPed'];
                $cForn->Visualizou($id);
                echo "<script>window.open('http://www.tele-tudo.com/pedido/" . $idPed . "', '_blank'); </script>";
                break;
        }
    }
    if ($cSessao->Som() == 1) {
        $som = "http://www.tele-tudo.com/mapa/Voz.mp3";
    } else {
        $som = "";
    }
    $VerTrans = false;
    ...
    ?>
    <form name="Form1"
          action="http://www.tele-tudo.com/fornecedor"
...
?>
<br>
<form action="http://www.tele-tudo.com/pedido/{{$idUltPedDia}}" name="Form3" target="_blank" >
...
<script>
    ...
    function ClicVisualizei(id, idPed) {
        // alert('aqui');
        document.location.assign("http://www.tele-tudo.com/fornecedor?op=1&id=" + id + "&idPed=" + idPed);
    }

    function ClicConfirmei(id, idPed, idTrans) {
        document.location.assign("http://www.tele-tudo.com/fornecedor?op=2&id=" + id + "&idPed=" + idPed + "&idTrans=" + idTrans);
    }

    function VerVenda(id, idPed) {
        // alert('x');
        document.location.assign("http://www.tele-tudo.com/fornecedor?op=3&id=" + id + "&idPed=" + idPed);
    }

    function recarrega() {
        document.location.assign("http://www.tele-tudo.com/fornecedor");
    }

    function produtos() {
        window.open('http://www.tele-tudo.com/Cadastro', '_blank');
    }

    function compras() {
        window.open('http://www.tele-tudo.com/produtos', '_blank');
    }

    function contasbancarias() {
        window.open('http://www.tele-tudo.com/contasbancarias', '_blank');
    }
    ...
    function entregas() {
        ...
        window.open('http://www.tele-tudo.com/confgentrega', '_blank');
    }
