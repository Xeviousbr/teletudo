...
class PessoaController extends BaseController {
    ...
    public function store()
    {
        ...
        if ($erro>'') {
            ...
            $pessoa->save();
            $ultPessoa = DB::table('pessoa')->max('id');
            ...
            if ($tpEnder=='E') {
                ...
                if ($idPessoa>0) {
                    ...
                    Session::flash('message', 'Você pode editar seu anúncio agora');

                    // Redireciona para o serviço
                    return Redirect::to('servicos/'.$this->idServico);
                } else {
                    if ($this->LograNovo==1) {
