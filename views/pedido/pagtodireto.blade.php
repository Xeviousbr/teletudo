...
*/
    ...
    function VeSeOFornViu() {
        ...
        $(function() {
            $.ajax({
                url: "http://www.tele-tudo.com/processo?op=8&idAviso="+idAviso,
                dataType: "html",
    ...
    function ClicouForma(forma) {
        ...
        document.location.assign("http://www.tele-tudo.com/pagtodireto?forma="+forma+'&trc=0'+'&com='+Coment);
    }

    function PagtoDinheiro() {
        var Coment = "'"+document.getElementById("txComentario").value+"'";
        document.location.assign("http://www.tele-tudo.com/pagtodireto?forma=1&trc="+Troco+'&com='+Coment);
    }

    function Cancelar() {
        if (confirm ("Tem certeza que deseja cancelar o pedido")) {
            alert("http://www.tele-tudo.com/processo?op=11&idPedido="+idPedido);
            $(function(){
                $.ajax({
                    url: "http://www.tele-tudo.com/processo?op=11&idPedido="+idPedido,
                    dataType: "html",
                    complete: function(msg){
                        document.location.assign("http://www.tele-tudo.com/pagtodireto?cancelou");
                    }
                });
            });
        }
