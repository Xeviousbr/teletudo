...
<title>Configura&ccedil;&otilde;es de Entrega</title>
...
if ($idUser==0) {
    echo '&Aacute;rea apenas para usu&aacute;rio registrado'; die;
}
$idUser = 26;
// Descobrir a cidade
$cCli = new Clientes();
...
<form class="sky-form boxed" method="post" name="formulario" action="{{ route('tpentregaempresa') }} ENCTYPE="multipart/form-data" style="width: 375px; border-width: medium; border-color: #FF0000;" >
