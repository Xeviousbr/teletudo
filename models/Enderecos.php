...
class Enderecos extends Eloquent
{

	protected $table = 'endereco';
	
	public function GetEndereco($id, $red) {
//		$enders = DB::table('endereco')
//			->select('endereco.Numero', 'logradouro.NomeLog','tplogradouro.nometplog', 'cidade.NomeCidade')	
...
//			->join('cidade', 'cidade.id', '=', 'logradouro.Cidade_ID');
