...
<table>
    ...
    // echo 'VlrCompras = clsEntrega->getCompras(idPedido)<Br>';
    $VlrCompras = $clsEntrega->getCompras($idPedido);

    // echo 'VlrEntrega = clsEntrega->getVlrEntrega()+clsEntrega->getVlrNosso()<Br>';
    $VlrEntrega = $clsEntrega->getVlrEntrega()+$clsEntrega->getVlrNosso();
