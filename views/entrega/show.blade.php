...
<script>
	...
	if (A<1) {
        ...
        function Solicita() {
            ...
            $(function(){
                $.ajax({
                    url: "http://www.tele-tudo.com/operacoes?op=1&idPedido="+idPedido+"&Token="+Token,
                    dataType: "html",
        ...
        function Efetiva() {
	        ...
	        // url: "http://www.tele-tudo.com/processo?op=6",

            $(function(){
                $.ajax({
                    url: "http://www.tele-tudo.com/processo?op=6&idPedido="+idPedido,
                    dataType: "html",
                    success: function(result){
        ...
        function VeSePagou(JaFez) {
            ...
            $(function(){
                $.ajax({
                    url: "http://www.tele-tudo.com/processo?op=4&idPedido="+idPedido+sTeste,
                    dataType: "html",
                    success: function(result){
                        if (result=='0') {
                            if (JaFez==0) {
        ...
        function VerMotora(Contador) {
            $(function(){
                $.ajax({
                    url: "http://www.tele-tudo.com/processo?op=2&vez="+Contador+"&Token="+Token,
                    dataType: "html",
                    success: function(result){
                        var ret = eval('('+result+')');
                        Contador++;
        ...
        function OndeEleTa() {
            $(function() {
                $.ajax({
                    url: "http://www.tele-tudo.com/processo?op=3&vez=" + Contador+sTeste+"&Token="+Token,
                    dataType: "html",
                    success: function(result) {
                    	Loga('OndeEleTa');
                        var ret = eval('(' + result + ')');
                        ...
                        if (status == 'finished') {                            
                            ...
                            document.location.assign("http://www.tele-tudo.com/resumo?IDPED="+idPedido);
        ...
        function MostraOCara() {
            $(function(){
                $.ajax({
                    url: "http://www.tele-tudo.com/processo?op=3&vez="+Contador+"&Token="+Token,
                    dataType: "html",
                    success: function(result){
                        var ret = eval('('+result+')');
                        var status = ret.status;
        ...
        function CancelaPagto() {
            ...
            if (confirm (textoA)) {
                ...
                $(function(){
                    $.ajax({
                        url: "http://www.tele-tudo.com/processo?op=11&idPedido="+idPedido,
                        dataType: "html",
                        complete: function(msg){
                            $('#pagAguarda').css({display:"none"});
                            $('#pagCanc').css({display:"none"});
